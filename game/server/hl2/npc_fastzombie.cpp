...
ConVar sk_zombie_fast_dmg_one_slash( "sk_zombie_fast_dmg_one_slash","3");
ConVar sk_zombie_fast_dmg_both_slash( "sk_zombie_fast_dmg_both_slash","5");
...
AI_BEGIN_CUSTOM_NPC( npc_fastzombie, CFastZombie )
	...
	(
		...
		"		TASK_MELEE_ATTACK1				0"
		//"		TASK_PLAY_SEQUENCE				ACTIVITY:ACT_FASTZOMBIE_FRENZY"
		"		TASK_SET_FAIL_SCHEDULE			SCHEDULE:SCHED_FASTZOMBIE_RANGE_ATTACK1"
		"		TASK_FASTZOMBIE_VERIFY_ATTACK	0"
		"		TASK_PLAY_SEQUENCE				ACTIVITY:ACT_FASTZOMBIE_FRENZY"
		"		TASK_FASTZOMBIE_VERIFY_ATTACK	0"
		"		TASK_PLAY_SEQUENCE_FACE_ENEMY	ACTIVITY:ACT_FASTZOMBIE_BIG_SLASH"
		"		TASK_SET_SCHEDULE			SCHEDULE:SCHED_FASTZOMBIE_RANGE_ATTACK1"
