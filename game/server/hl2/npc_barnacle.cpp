...
ConVar	sk_barnacle_dmg( "sk_barnacle_dmg","0");
ConVar	sk_barnacle_health_simple( "sk_barnacle_health_simple","0");
ConVar	sk_barnacle_pull_speed_phys( "sk_barnacle_pull_speed_phys","0");
ConVar	sk_barnacle_pull_speed_plr( "sk_barnacle_pull_speed_plr","0");
...
#define BARNACLE_BITE_DAMAGE_TO_PLAYER					30
...
void CNPC_Barnacle::Spawn()
{
    ...
    m_flBarnaclePullSpeed = sk_barnacle_pull_speed_phys.GetFloat();
	...
	if( !Q_strnicmp( szMapName, "d1_canals", 9 ) )
	{
		// Canal Barnacles are weaker
		m_iHealth = sk_barnacle_health_simple.GetFloat();
	}
	else
	{
...
void CNPC_Barnacle::AttachTongueToTarget( CBaseEntity *pTouchEnt, Vector vecGrabPos )
{
	...
	{
    	m_flBarnaclePullSpeed = sk_barnacle_pull_speed_plr.GetFloat();
	}
...
void CNPC_Barnacle::BitePrey( void )
{
	...
	{
		nDamage = sk_barnacle_dmg.GetFloat(); 
	}
