...
void CBaseAnimating::StudioFrameAdvanceInternal( CStudioHdr *pStudioHdr, float flCycleDelta )
{
	...
	*/
	...
	m_flGroundSpeed = ( GetSequenceGroundSpeed( pStudioHdr, GetSequence() ) * GetModelScale() ) * m_flGroundSpeedMultiplier;
...
float CBaseAnimating::GetIdealAccel( ) const
{
	...
	return ( GetIdealSpeed() + 50 ) * m_flAccelerationMultiplier;
}
