...
void CWeaponAR2::DelayedAttack( void )
{
	...
	// Fire the bullets
	Vector vecVelocity = vecAiming * sk_plr_weapon_ar2_alt_fire_speed.GetFloat();
	...
	m_flNextPrimaryAttack = gpGlobals->curtime + 0.50f;
...
void CWeaponAR2::FireNPCSecondaryAttack( CBaseCombatCharacter *pOperator, bool bUseWeaponAngles )
{
	...
	// Fire the bullets
	Vector vecVelocity = vecAiming * sk_npc_weapon_ar2_alt_fire_speed.GetFloat(); // i changed this
