...
// -------------------------------------------------------------------------------- //
	...
	BEGIN_RECV_TABLE_NOBASE( C_BasePlayer, DT_LocalPlayerExclusive )
		...
		RecvPropInt			( RECVINFO(m_fIsManned) ),
		RecvPropInt			( RECVINFO(m_iMannedGunAmmo) ),
...
BEGIN_PREDICTION_DATA( C_BasePlayer )
	...
	DEFINE_PRED_FIELD( m_fIsManned, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( m_iMannedGunAmmo, FIELD_INTEGER, FTYPEDESC_INSENDTABLE ),
