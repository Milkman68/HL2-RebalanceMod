...
public:
	...
	virtual	bool		Weapon_CanSwapTo( C_BaseCombatWeapon *pOldWeapon, C_BaseCombatWeapon *pNewWeapon );

	virtual bool		Weapon_SlotOccupied( C_BaseCombatWeapon *pWeapon );
	virtual C_BaseCombatWeapon *Weapon_GetSlot( int slot, int position ) const;
