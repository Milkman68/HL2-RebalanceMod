...
ConVar	sk_plr_num_shotgun_pellets( "sk_plr_num_shotgun_pellets","0", FCVAR_REPLICATED);
ConVar	sk_plr_num_shotgun_pellets_double( "sk_plr_num_shotgun_pellets_double","0", FCVAR_REPLICATED);
ConVar	sk_npc_num_shotgun_pellets( "sk_npc_num_shotgun_pellets","0", FCVAR_REPLICATED);
...
ConVar sk_npc_dmg_strider_episodic			( "sk_npc_dmg_strider_episodic", "0", FCVAR_REPLICATED );
...
ConVar  alyx_darkness_force( "alyx_darkness_force", "0", FCVAR_CHEAT | FCVAR_REPLICATED );
	...
	void CHalfLife2::InitDefaultAIRelationships( void )
	{
		...
		*/
		...
		if( hl2_episodic.GetBool() )//bookmark
		{CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE,		CLASS_METROPOLICE,		D_HT, 0); }
		else //bookmark
		...
		*/
		...
		if( hl2_episodic.GetBool() )//bookmark
		{CBaseCombatCharacter::SetDefaultRelationship(CLASS_METROPOLICE,	CLASS_COMBINE,			D_HT, 0);}
		else
...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		bInitted = true; //This calculates the Physics force for all ammo types. bookmark
...
#ifdef HL2_EPISODIC
		def.AddAmmoType("StriderMinigun",	DMG_BULLET,					TRACER_LINE,			"sk_npc_dmg_strider_episodic", "sk_npc_dmg_strider_episodic_to_plr", NULL, 9000, AMMO_FORCE_DROP_IF_CARRIED ); // hit like a 1.0kg weight at 750 ft/s
#else
		def.AddAmmoType("StriderMinigun",	DMG_BULLET,					TRACER_LINE,			"sk_npc_dmg_strider", "sk_npc_dmg_strider_to_plr", NULL,  9000, AMMO_FORCE_DROP_IF_CARRIED ); // hit like a 1.0kg weight at 750 ft/s
#endif//HL2_EPISODIC
