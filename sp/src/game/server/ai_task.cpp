...
void CAI_BaseNPC::InitDefaultTaskSR(void)
{
	...
	ADD_DEF_TASK( TASK_GET_FLANK_ARC_PATH_TO_ENEMY_LSP_LOS );
	ADD_DEF_TASK( TASK_GET_PATH_TO_ENEMY_LSP_LOS );
	ADD_DEF_TASK( TASK_GET_PATH_TO_RANGE_ENEMY_LKP_LOS );
	ADD_DEF_TASK( TASK_GET_PATH_TO_ENEMY_LOS_IN_WEAPON_RANGE );
	ADD_DEF_TASK( TASK_GET_PATH_TO_ENEMY_LKP_LOS_IN_WEAPON_RANGE );
	...
	ADD_DEF_TASK( TASK_FIND_COVER_FROM_ORIGIN_AND_ENEMY );
	ADD_DEF_TASK( TASK_FIND_COVER_FROM_ORIGIN );
	ADD_DEF_TASK( TASK_FIND_NEAR_COVER_FROM_ORIGIN );
	ADD_DEF_TASK( TASK_FIND_FAR_COVER_FROM_ORIGIN );
	ADD_DEF_TASK( TASK_FIND_COVER_FROM_ENEMY_IN_WEAPON_RANGE );
