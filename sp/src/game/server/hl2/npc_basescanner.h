...
#define SCANNER_ATTACK_NEAR_DIST		150		// Fly attack min distance 150
#define SCANNER_ATTACK_FAR_DIST			400		// Fly attack max distance 300
#define SCANNER_ATTACK_RANGE			450		// Attack max distance     350
#define	SCANNER_ATTACK_MIN_DELAY		3		// Min time between attacks
#define	SCANNER_ATTACK_MAX_DELAY		5		// Max time between attacks
#define	SCANNER_EVADE_TIME				2		// How long to evade after take damage
